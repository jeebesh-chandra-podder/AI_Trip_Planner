...
with st.container():
    ...
    with st.form(key="query_form", clear_on_submit=True):
        user_input = st.text_input("", placeholder="e.g. Plan a 5-day trip to Goa including hotels and budget breakdown")
            ...
            if response.status_code == 200:
                ...
                with st.expander("📋 Trip Overview", expanded=True):
                    st.markdown(f"""
                        ...
                        #### 🤖 Generated by Jeebesh's AI Travel Agent
                        ---
                        {answer}
                        ---
...
st.markdown("""
---
<center>Made with ❤️ using Agentic AI | Powered by OpenAI & Streamlit | Jeebesh Chandra Podder</center>
""", unsafe_allow_html=True)
